...
import { Link, Display, Card,Grid } from '@geist-ui/react'
import Rader from 'lib/components/feeds/rader'

export const meta = {
  title: '고양이사료 오리젠에 대해서',
...
<Grid.Container gap={2} justify="center" alignItems="center">
  <Grid xs><img src="https://orijen.ca/dw/image/v2/BFDW_PRD/on/demandware.static/-/Sites-cpf-master-catalog/default/dw3ebdc188/images/northstar/NS%20ORIJEN%20Six%20Fish%20Cat%20Front%20Right%205.4kg.png?sw=800&sh=800&sm=fit" alt="pic1" title="文字が大きい" /></Grid>
  <Grid xs><Rader /></Grid>
</Grid.Container> 
